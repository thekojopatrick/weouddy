      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        <div className="max-w-3xl text-left mb-24">
          <h1 className="text-2xl mb-6">
            WeOuddy is a social platform that reimagines how people
 ...
 */}
        <div className="text-center py-16">
          <p className="mb-4">
            Get access to profile analytics, custom domains, and
            exclusive premium features while supporting our mission.
          </p>
