      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="max-w-3xl mx-auto text-center mb-16">
          ...
          <div className="prose prose-sm max-w-none text-neutral-500 dark:text-neutral-400 space-y-4">
            ...
            <p className="text-base text-left">
              We realized that traditional event platforms were missing the
              mark, failing to capture the magic of shared memories and
              real-time connections. As developers, creatives and event
              enthusiasts, we set out to create a better way to bring people
              together and preserve those moments for a lifetime.
            </p>
            <p className="text-base text-left">
              Today, we&apos;re at a crucial turning point. Our platform has
              grown beyond our initial dreams, looking to serve thousands of
              event creators,regular individuals and attendees. But to take this
              vision to the next level - to truly impact how people connect and
              celebrate - we need your support.
            </p>
            <div className="">
              ...
              <div className="grid md:grid-cols-1 gap-2">
                ...
                <p className="text-left text-base">
                  ...
                  more user research, enhance our platform’s features, and bring
                  this transformative idea to life. By joining us, you’re not
                  just supporting a platform—you’re helping to shape the future
                  of how we connect, celebrate, and preserve life’s most
                  meaningful moments.
                </p>
              </div>
            </div>
        ...
        <section className="my-16">
          ...
          <div className="bg-white p-8 rounded-lg shadow-xs border text-center max-w-3xl mx-auto">
            <p className="text-base italic mb-4 text-neutral-600">
              &quot;Be the first to support us and leave your mark!&quot;
            </p>
            <p className="font-bold text-neutral-700">- Future Supporter</p>
          </div>
          <div className="grid mt-8">
            <p className="text-neutral-600 text-center">
              Thank you for believing in our vision. Together, we can make
              events unforgettable!
            </p>
            <div className="grid grid-cols-4">{/** List of sponsors */}</div>
          </div>
        </section>
