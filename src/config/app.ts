...
export const applicationName = 'WeOuddy';
export const companyName = 'Eadith Studios, LLC';
export const SITE_URL = 'https://www.weouddy.com';

export const MAX_UPLOAD_IMAGE_SIZE_IN_MB = 5;
export const MAX_UPLOAD_IMAGE_SIZE =
  1024 * 1024 * MAX_UPLOAD_IMAGE_SIZE_IN_MB;
...
export const afterLoginUrl = '/discover';
